                  ...
                  div [ Class "w-full p-4 sm:mt-8 sm:w-5/6 sm:rounded-lg sm:shadow-lg bg-white  flex flex-col items-center justify-start"]
                    [
                      ...
                      div [ Class "mb-4 text-justify" ]
                        [ "From our last offline retro at DDD Europe, more and more people felt the need for an online conference. DDDDD is our call to that to start exploring the world of online collaboration and sharing of knowledge. We will present more details the closer we go to the conference date." |> ofString ]
